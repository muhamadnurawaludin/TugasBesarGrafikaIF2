        ...
        for (unsigned int x = 0; x < w; x++) {
                for (unsigned int k = 0; k < h2; k++) {
                        ...
                        if (x < w / 2)
                                ...
                                dest[k][x] = mmxroundTH(s); 	       

                        dest[k+h2][x] = mmxroundTH(d);          
                }
        }
}


void FWT2D::synthrows(char** dest, char** sour, unsigned int w, unsigned int h) const     
{
        int n;
        float s2k, s2k1;
...
void FWT2D::synthcols(char** dest, char** sour, unsigned int w, unsigned int h) const    
{
        int n;
        float s2k, s2k1;
