...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void) {
			...
			this->pictureBox->Size = System::Drawing::Size(342, 240);
			this->pictureBox->TabIndex = 0;
			this->pictureBox->TabStop = false;
			this->pictureBox->Click += gcnew System::EventHandler(this, &FChildPic::pictureBox_Click);
...
private:
        System::Void transrgbToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
                ...
                setRGB(m_clone, rfwt->getspec(), gfwt->getspec(), bfwt->getspec()); 
